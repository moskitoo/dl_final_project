...
def parse_args():
    ...
    parser.add_argument('--learning_rate', type=float, default=0.0005879, help='learning rate')
    ...
    parser.add_argument('--project_name', type=str, default='UnetBase_Brightfield', help='name of the project')
