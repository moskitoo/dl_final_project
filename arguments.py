...
def parse_args():
    ...
    parser.add_argument('--learning_rate', type=float, default=0.000143, help='learning rate')
    parser.add_argument('--batch_size', type=int, default=16, help='number of minibatches to split the batch into')
    parser.add_argument('--num_epochs', type=int, default=10, help='number of epochs to train the network for')
    parser.add_argument('--model_name', type=str, default='Unet_simple', help='name of the model to use')
    ...
    parser.add_argument('--weight_decay', type=int, default=0.00001516, help='number of classes')
