...
def parse_args():
    ...
    parser.add_argument('--project_name', type=str, default='Unet_Brightfield_2D_loss_abalation_v1', help='name of the project')
    ...
    parser.add_argument('--patience', type=int, default=20, help='number of classes')
...
def parse_args_3dunet():

    parser = argparse.ArgumentParser()
    parser.add_argument('--seed', type=int, default=276, help='seed of the experiment')
    parser.add_argument('--learning_rate', type=float, default=0.0001139, help='learning rate')
    parser.add_argument('--batch_size', type=int, default=16, help='number of minibatches to split the batch into')
    parser.add_argument('--num_epochs', type=int, default=80, help='number of epochs to train the network for')
    parser.add_argument('--model_name', type=str, default='Unet3D_simple_11_no_preprocess', help='name of the model to use')
    parser.add_argument('--sample_size', type=int, default=512, help='number of classes')
    parser.add_argument('--project_name', type=str, default='Unet_Brightfield_3D_loss_abalation_v2', help='name of the project')
    parser.add_argument('--step_size', type=int, default=7, help='number of classes')
    parser.add_argument('--gamma', type=int, default=0.1, help='number of classes')
    parser.add_argument('--weight_decay', type=int, default=0.00006335, help='number of classes')
    parser.add_argument('--momentum', type=int, default=0.9, help='number of classes')
    parser.add_argument('--optimiser', type=str, default='adam', help='number of classes')
