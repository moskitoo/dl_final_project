...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='Unet_simple_11_no_preprocess', help='name of the model to use')
...
def parse_args_3dunet():
    ...
    parser.add_argument('--num_epochs', type=int, default=200, help='number of epochs to train the network for')
    parser.add_argument('--model_name', type=str, default='Unet3D_simple_11_preprocess', help='name of the model to use')
    parser.add_argument('--sample_size', type=int, default=512, help='number of classes')
